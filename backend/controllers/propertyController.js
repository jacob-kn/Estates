...
const createProperty = asyncHandler(async (req, res) => {
  console.log("QD :" + req.body.Quadrant);
  console.log("qd :" + req.body.quadrant);
  console.log("req: "+util.inspect(req, {showHidden: false, depth: null, colors: true}))
  console.log("req.body: "+util.inspect(req.body, {showHidden: false, depth: null, colors: true}))
  console.log("req.headers: "+util.inspect(req.headers, {showHidden: false, depth: null, colors: true}))
  ...
  //   console.log("file :" + newFileNameSpaces);
